...
sed -e "s/\${Pro4K}/"$Pro4K"/" -e "s/\${ProHD}/"$ProHD"/"  -e "s/\${Hq4K}/"$Hq4K"/" -e "s/\${HqHD}/"$HqHD"/" -e "s/\${HqVGA}/"$HqVGA"/"  -e "s/\${cb}/"$cb"/" /opt/home/scripts/gui_br_NX1.tp >  /tmp/gui_br.NX1
sync;sync;sync
########################################################################################
...
##############################################
sed -e "s/\${p_1}/"$p_1"/" -e "s/\${p_2}/"$p_2"/" -e "s/\${p_3}/"$p_3"/" -e "s/\${p_4}/"$p_4"/" -e "s/\${p_5}/"$p_5"/" -e "s/\${p_6}/"$p_6"/" -e "s/\${p_7}/"$p_7"/"  -e "s/\${p}/"500"/" /opt/home/scripts/gui_ramp_ov.tp > /tmp/gui_ramp.NX500
sed -e "s/\${p_1}/"$p_1"/" -e "s/\${p_2}/"$p_2"/" -e "s/\${p_3}/"$p_3"/" -e "s/\${p_4}/"$p_4"/" -e "s/\${p_5}/"$p_5"/" -e "s/\${p_6}/"$p_6"/" -e "s/\${p_7}/"$p_7"/"  -e "s/\${p}/"1"/" /opt/home/scripts/gui_ramp_ov.tp > /tmp/gui_ramp.NX1
##############################################
sync;sync;sync
exit
